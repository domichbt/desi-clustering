...
import sys
sys.path.append("/global/homes/d/dforero/codes/desi-clustering/")
...
def get_theory(
    ...
    template = ShapeFitPowerSpectrumTemplate(fiducial=fiducial, cosmo=cosmo, z=z)
...
if __name__ == '__main__':
    ...
    chain_name = (
        f'/pscratch/sd/d/dforero/projects/y3-20t-3pt-bispec-mc/data/test_dr2_sf/chain_{args.fit_type}_{tracer_str}_{args.region}'
    )
